            ...
            <div className="grid grid-cols-1 md:grid-cols-2">
              <div className="p-10 mr-2 bg-gray-100 dark:bg-gray-800 sm:rounded-lg">
                ...
                <div className="ml-4 text-md tracking-wide font-semibold w-40">
                    Rua Embaixador Mario Guimarães, Vila Constança, São Paulo-SP,
                    02259-080
                </div>
                </div>
              ...
              <form className="p-6 flex flex-col justify-center">
                        <div className="flex flex-col">
                            <label htmlFor="name" className="hidden">Nome Completo</label>
                        ...
                        <div className="flex flex-col mt-2">
                            <label htmlFor="tel" className="hidden">Celular</label>
                        ...
                        <div className="flex flex-col mt-2">
                          ...
                          <textarea  type="message" id="message" name="message" placeholder="Message" rows="4" className="w-100 mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 font-semibold focus:border-indigo-500 focus:outline-none"> </textarea>
                      </div>
