    ...
    <div className='flex-grow bg-gray-200  w-full min-h-screen'>
      <div className='container mx-auto px-8 py-5'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 mt-6'>
            ...
            <Card image="/img/image-1.jpg" icon="/img/icons8-typescript.svg" title="Portifolio usando NextJS" description="Pagina de portifolio utiliazndo nextjs e jsx."/>
            <Card image="/img/image-1.jpg" icon="/img/icons8-java.svg" title="Painel em flutter" description="Painel administrativo feito no curso de Dart do TI Contigo"/>
        </div>
      </div>
    </div>
  </div>
